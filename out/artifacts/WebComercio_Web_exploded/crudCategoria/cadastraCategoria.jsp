...
<div class="container-fluid">
    <div class="container" style="width: 500px">
        <h1 class="text-center text-info m-4">Cadastra Categoria</h1>
        <form class="m-5" action="../cadastra_categoria" method="post">
...
<footer class="bg-dark text-light pt-4 mt-4">
    ...
    <div class="container-fluid text-center bg-dark mt-3">
        <p class="text-light p-2">© 2018 Copyright:<a class="text-light" href="../index.jsp"> WebComércio.com </a></p>
    </div>
    <!--/.Copyright-->
