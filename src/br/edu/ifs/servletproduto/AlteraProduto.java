...
public class AlteraProduto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Produto produto = new Produto(idProduto, cod, nome, descricao, marca, valor, modelo, idCategoria, "");
        ...
        for (Part part : request.getParts()) {
            ...
            if (!nomeArquivo.equals("")) {
                fileName = "produto_" + idProduto + "_" + Math.floor(Math.random() * 1000) + nomeArquivo.substring(nomeArquivo.lastIndexOf('.'));
                part.write(savePath + File.separator + fileName);

                dao.gravaFoto(idProduto, SAVE_DIR + "/" + fileName);
            }
        }
