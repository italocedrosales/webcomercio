...
<div class="container-fluid">
    <div class="container" style="width: 500px">
        <h1 class="text-center text-info m-4">Excluir Categoria</h1>
        <%
            int id = Integer.parseInt(request.getParameter("idCategoria"));
            CategoriaDAO dao = new CategoriaDAO();
            Categoria categoria = dao.getCategoria(id);
        %>
        <form class="m-5" action="../exclui_categoria" method="get">
            <input type="hidden" name="idCategoria" value="<%=categoria.getIdCategoria()%>">
            <div class="form-group">
                <label for="nome">Nome:</label>
                <input disabled="disabled" class="form-control" type="text" id="nome" name="nome"
